...
RUN wget --no-check-certificate --progress=dot:mega -O - https://s3-us-west-1.amazonaws.com/relateiq-build-resources/apache-cassandra-2.0.8-bin.tar.gz | tar -zx -C /opt/cassandra --strip-components=1
